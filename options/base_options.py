...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--image_name', type=str, default='images-full', help='image folder name, [images-full | images-part]')
        parser.add_argument('--geo_trans', type=int, default=0, help='applying geo-transformation to both images and conditional maps')
        parser.add_argument('--train_name', type=str, default='', help='train file name')
        parser.add_argument('--test_name', type=str, default='', help='test file name')
        parser.add_argument('--vdim', type=int, default=13, help='# of landuse categories')
        parser.add_argument('--cond_dim', type=int, default=1, help='# channels of conditional map')
        parser.add_argument('--cond_type', type=str, default='triangle', help='[keypoint | skeleton | boundary | triangle]')
