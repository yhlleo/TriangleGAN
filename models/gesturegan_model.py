...
class GestureGANModel(BaseModel):
    """
    GestureGAN
    """
    @staticmethod
    ...
    def backward_D(self):
        ...
        self.loss_D = (loss_D_real_A + loss_D_fake_A + loss_D_real_B + loss_D_fake_B) *  0.5
    ...
    def backward_G(self):
        ...
        self.loss_GAB = (loss_G_A + loss_G_B) * 0.5 * self.opt.lambda_adv
